locals {
  ...
  lambda_functions = {
    prd : [
      { name : "join-game", create : true, cf_path : "/api/join", needs_auth_secret : true },
      { name : "get-game", create : true, cf_path : "/api*", needs_auth_secret : true },
      ...
      { name : "submit-action", create : true, cf_path : "/api/submit", memory_size : 1024, timeout : 10, needs_auth_secret : true },
      { name : "create-game", create : true, cf_path : "/api/create", needs_auth_secret : true },
