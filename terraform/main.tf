locals {
  ...
  lambda_functions = {
    prd : [
      { name : "join-game", create : true, needs_auth_secret: true },
      { name : "get-game", create : true, needs_auth_secret: true },
      # sample: Billed Duration: 986 ms    Memory Size: 1024 MB    Max Memory Used: 131 MB
      { name : "submit-action", create : true, memory_size : 1024, timeout : 10, needs_auth_secret: true },
      { name : "create-game", create : true, needs_auth_secret: true },
